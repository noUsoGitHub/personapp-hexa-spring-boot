...
public class EstudiosMenu {
    ...
    private static final String FORMATO_FECHA_INCORRECTO = "Formato de fecha incorrecto. Intente nuevamente.";
    private static final String OPCION_INVALIDA = "La opción elegida no es válida. Intente nuevamente.";
    ...
    private void mostrarMenuOpciones() {
        ...
        System.out.println(OPCION_VER_TODO + " - Ver todas las carreras");
        System.out.println(OPCION_VER_UNO + " - Ver una carrera");
        System.out.println(OPCION_CREAR + " - Crear una carrera");
        System.out.println(OPCION_EDITAR + " - Editar una carrera");
        System.out.println(OPCION_ELIMINAR + " - Eliminar una carrera");
        System.out.println(OPCION_REGRESAR_MOTOR_PERSISTENCIA + " - Regresar");
    }

    private void mostrarMenuMotorPersistencia() {
        System.out.println("==== Menú de Motores de Persistencia ====");
    ...
    private EstudiosModelCli leerEstudios(Scanner keyboard) {
        try {
            ...
            log.warn(FORMATO_FECHA_INCORRECTO);
            // Limpiar el buffer del teclado
            keyboard.nextLine();
            return new EstudiosModelCli(0, 0, null, "");
        }
